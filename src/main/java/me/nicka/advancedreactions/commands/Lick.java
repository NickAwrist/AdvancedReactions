    ...
    public Lick(){
        ...
        new CommandBase("lick", 1, 1, true){
            ...
            public boolean onCommand(CommandSender sender, String[] arguments){
                ...
                Particle p = Particle.valueOf(config.getString("Messages.Lick.Particle"));
                Sound s = Sound.valueOf(config.getString("Messages.Lick.Sound"));

                if(config.getString("Messages.Lick.Sound").equals(""))
                    s = Sound.ENTITY_PUFFER_FISH_AMBIENT;
                if(config.getString("Messages.Lick.Particle").equals(""))
